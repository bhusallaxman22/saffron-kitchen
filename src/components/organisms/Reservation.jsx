...
export default function Reservation() {
    ...
    return (
        <section id="reservation" className="py-20 px-6 bg-[#f9f9f9] text-gray-900 text-center">
            <div className="container mx-auto max-w-2xl">
                <h2 className="font-extrabold text-5xl mb-4 font-playfair">Make a Reservation</h2>
                <p className="text-gray-700 text-xl mb-2">{availability}</p>
                <p className="text-gray-700 text-xl mb-8">Reserve your table for a futuristic dining experience.</p>

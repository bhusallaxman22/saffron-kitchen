      ...
      <footer className="bg-creamy-white text-gray-900 py-8 px-6">
        <div className="container mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-8 border-b border-gray-300 pb-6">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              >
                ...
                <motion.button
                  ...
                  className={`w-full ${
                    loading ? "bg-gray-400" : "bg-saffron"
            ...
            <div className="flex-1 text-left md:text-right">
              ...
              <p className="text-base">
                ...
                {brandDetails.operatingHours.wednesdayToMonday}
              </p>
              <p className="text-base">
                <strong>Fri - Sat:</strong> 11:30 AM - 2:30 PM | 5:00 PM - 11:00
                PM
              </p>
              <p className="text-base">
          ...
          <div className="mt-4 text-center text-xs text-gray-500">
            &copy; {new Date().getFullYear()} {brandDetails.name}. All rights
            reserved.
          </div>
        </div>
      </footer>

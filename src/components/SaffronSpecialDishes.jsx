...
// Icon components for special tags (if needed)
...
export default function SaffronSpecialDishes() {
  ...
  return (
    <section
      id="saffron-specials"
      className="py-20 bg-[#f9f9f9] text-gray-900 relative"
    >
            ...
            {dishes.map((dish, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-black bg-opacity-30 flex flex-col justify-end p-4">
                  {/* Allow the name to wrap naturally */}
                  <h3 className="text-2xl font-bold break-words">{dish.name}</h3>

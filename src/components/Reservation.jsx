  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-2xl">
        <h2 className="font-extrabold text-5xl mb-4">Make a Reservation</h2>
        <p className="text-gray-400 text-xl mb-2">{availability}</p>
        ...
        <form className="space-y-6">
          <div>
            ...
            <input
              ...
              focus:ring-2 focus:ring-saffron transition transform focus:scale-105"
              required
            />
          </div>
          <div>
